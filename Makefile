...
MACROS__MAIN__DISSP=-DDTYPE=3 -DVISC_SMALLSCALE=1.0D-8 -DVISC_LARGESCALE=1.0D+3
MACROS__MAIN__NUMERICS=-DNT=100 -DNTI=1000 -DDT=1.0D-7
...
MACROS__MAIN=$(MACROS__MAIN__MODEL) $(MACROS__MAIN__FORCE) $(MACROS__MAIN__DISSP) $(MACROS__MAIN__NUMERICS) $(MACROS__MAIN__OTHER)
